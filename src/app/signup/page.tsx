...
export default function Signup() {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post<APIResponse>('https://api-todo-list-pbw.vercel.app/auth/register', formData);
            ...
            setErrorMessage("Failed to sign up. Make sure the data you entered is correct or check your internet connection.");
            setShowLoading(false);
        ...
        <div className="flex flex-col w-full h-screen items-center overflow-hidden">
            ...
            <div className="w-screen h-screen top-0 fixed flex items-center justify-center">
                <div className="glass form w-[420px] fixed flex flex-col gap-[2.4em] items-center justify-center">
                    ...
                    <form onSubmit={handleSignUp} className="flex flex-col items-center justify-left gap-[1.2em]">
                        <input type="text" className="input w-full text-[12pt]" placeholder="Full name" value={formData.fullName} onChange={(e) => setFormData({ ...formData, fullName: e.target.value })} required/>
                        ...
                        <div className="input flex flex-row items-center justify-center gap-[8px]">
                            ...
                            {firstClick ? (
                                <svg className="form-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" onClick={handelPasswordState}>
                        ...
                        <button type="submit" className="solid-button text-[12pt] w-[160px] mt-[1.2em]" onClick={() => setShowLoading(true)}>Sign Up</button>
                    </form>
                </div>
            </div>
